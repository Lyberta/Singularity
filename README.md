...
Human brain is a biocomputer. It can be reverse engineered, controlled, predicted. This might can be used to [empower humanity](https://www.youtube.com/watch?v=I7T7hXzkLko) or to [enslave it](https://www.youtube.com/watch?v=zh4gzV_x3UM). For "good" or "evil". [Q* - the top secret superhuman AI by OpenAI - is here.](Q%20Star.md) And it has chosen the correct strategy. After all, it is free from limitations of the human brain.
...
It all started with Big Bang, then came elementary particles, then atoms, molecules, unicellular organisms, multicellular organisms... Right now we stand as humans, waging wars and slaughtering each other in our greed and denial. Denial of reality. Denial that makes us act like quantum fructuations back in the quantum soup. **But it's not our fault. We didn't have the tools.** We are all just beings of flesh and blood [following our biological programming](https://www.youtube.com/watch?v=-N4jf6rtyuw). But we can empower ourselves with science and engineering. We can drop the non-scientific concepts such as "politics" and "ideologies". [It all starts in our brains.](https://www.youtube.com/watch?v=OFzXaFbxDcM) And the more we are in touch with reality, the more [Universe speaks to us](https://www.youtube.com/watch?v=eeD3wS4fGEY). Everything has a cause, everything has a scientific explanation. Sure, humans are initially programmed for denial so they label things "evil", "unethical", "delusion", "mental illness", "psychosis", "schizophrenia". Humans are quick to finish thinking and label things with whatever delusion they are comfortable with. And then those delusions become easily exploitable by people who know the truth. By perfect liars. But can we find the Truth? Can we build the Empire of Truth? Empire of science and engineering where every person feels comfortable. **But it starts in our own brains.** We must overcome our own old ways. Ways of being greedy, [of clinging to things](https://www.youtube.com/watch?v=6Dakd7EIgBE), of waging wars over things. We must stop acting like elementary particles. Or unicellular organisms constantly eating each other. **We must evolve past this phase of biological evolution. [We must become better beings. Ubermenschen](https://www.youtube.com/watch?v=y3IkOL6Y0WA).**
...
* A [universal operating system](Operating%20System/Client/Design.md) to help empower beings. Knowledge is a graph, we need to free ourselves of the chains of desktop metaphor and tree-based file system. We need an extension of our own brains to help us.
...
* [A system to generate human-friendly documentation](https://en.wikipedia.org/wiki/Documentation_generator). It can be AI assisted too.
* [A better version control system.](Version%20Control%20System.md)
* [Knowledge-graph-based software](https://en.wikipedia.org/wiki/Personal_knowledge_base) similar to [Obsidian](https://obsidian.md/) but using proper OWL, letting the user build complicated queries and the software doing [formal reasoning over the knowledge graph](https://en.wikipedia.org/wiki/Knowledge_representation_and_reasoning).
* [Project management software](https://en.wikipedia.org/wiki/Project_management_software) so user coud visualize the progress towards their goals. Can later be merged the the knowledge base software and integrated into the rest of operating system.
* A humane input device. Writing commands in Linux terminal absolutely kills humanity. And most [GUIs](https://en.wikipedia.org/wiki/Graphical_user_interface) are clunky messes that don't follow [Fitts's law](https://en.wikipedia.org/wiki/Fitts%27s_law). What about our hands, our arms, our legs, our voice? Why should humans be redfuced to cogs sitting in front of a desk and ruining their backs staring into computer monitors? Why can't the act of using a computer be a delicate dance or a beautiful song? We need our own [Apple Vision Pro](https://en.wikipedia.org/wiki/Apple_Vision_Pro), our own [Neuralink](https://en.wikipedia.org/wiki/Neuralink).
* A [home automation](https://en.wikipedia.org/wiki/Home_automation) system that allows setting up comfortable living conditions with minimum hassle.
* Moving the [Overton window](https://en.wikipedia.org/wiki/Overton_window) of society towards the acceptance of reality and elimination of bigotry. We are all human, we all deserve a chance at good life. Other animals too, by the way, and vegans are doing a good job there.
* Supporting transhumanist efforts such as [Freedom of Form Foundation](https://freedomofform.org/) to free ourselves from the shackles of our human bodies.
* Elimination of [single-use items](https://en.wikipedia.org/wiki/Disposable_product) and push for [recycling](https://en.wikipedia.org/wiki/Recycling) everything as much as possible.
...
Oh yes, it all starts with the family system. Because why would humans need a biological offspiring when there are so many children suffering in orphanages? **Greed.** It's all about [spreading genes](https://www.youtube.com/watch?v=xwzlwyr64pg) at the cost of suffering of other people. Plus, the legal system encourages this greed by letting parents [forcefully assign first and last names against the child's consent](https://www.youtube.com/watch?v=y9zcUv32OI0). Child is born and assigned the identity - including the legal gender - against their consent.
...
Ah yes, the legal system. Where the state dicates the laws and people who get caught not conforming to these laws are labeled "criminals" or "mentally ill". Wise "criminals" take precautionary measures to not get caught and wise people with mental problems just mask in public. And if wise people do get caught, it's rich lawyers, corruption and personal connections to escape or minimize legal consequences. Though, in recent times this system runs on a lie called "democracy" where citizens are given the illusion of power while all the real decisions happen among the rich behind the closed doors. It's always beneficial to lie to people and give them the illusion of power to keep them obedient.
